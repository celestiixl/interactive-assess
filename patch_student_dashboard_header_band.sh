...
export default function StudentDashboard() {
  ...
  return (
    <main className="min-h-dvh bg-slate-50 text-slate-900">
      ...
      <div className="bg-gradient-to-r from-sky-500 via-blue-600 to-indigo-600">
      ...
      <div className="mx-auto -mt-5 max-w-6xl px-6 pb-10">
        <div className="rounded-[28px] border bg-white p-6 shadow-sm">
          ...
          <section className="rounded-2xl border bg-white p-6 shadow-sm">
            {tab === "overview" ? (
              <>
                <MasteryDonut segments={segments as any} />
              ...
              <>
                ...
                <SpecimenGrid segments={segments as any} />
              </>
            )}
          </section>
...
echo "2) Clear cache: rm -rf apps/web/.next"
echo "3) Restart on 3001:"
