...
export default function ItemRenderer({
  ...
  switch (item.kind) {
    ...
    case "dragDrop":
      return <DragDrop item={item as any} onChecked={onChecked} />;
    case "cardSort":
      return <CardSort item={item as any} onChecked={onChecked} />;
    case "hotspot":
      return <Hotspot item={item as any} onChecked={onChecked} />;
    case "short":
