...
export default function SpecimenGrid({ segments }: Props) {
  ...
  const specimens = useMemo(() => {
    ...
    const arr = Object.values(grouped).sort((a, b) => {
      if (
        a.organism.name === "Unknown organism" &&
        b.organism.name !== "Unknown organism"
      )
        return -1;
      if (
        b.organism.name === "Unknown organism" &&
  ...
  return (
    <div className="mt-6">
        ...
        {specimens.map((s, i) => {
          ...
          return (
            ...
            >
              ...
              <div
                className={[
                  "mx-auto flex h-12 w-12 items-center justify-center rounded-2xl border bg-white/0",
      ...
      <style jsx global>{`
        ...
        .confetti span.conf-sm {
          width: 6px;
          height: 6px;
        }
        .confetti span.conf-md {
          width: 10px;
          height: 10px;
        }
        .confetti span.conf-lg {
          width: 14px;
          height: 14px;
        }
        ...
        .confetti span.star-sm {
          width: 6px;
          height: 6px;
        }
        .confetti span.star-md {
          width: 10px;
          height: 10px;
        }
        .confetti span.star-lg {
          width: 15px;
          height: 15px;
        }
