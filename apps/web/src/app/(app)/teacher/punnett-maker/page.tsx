    ...
    <div className="overflow-auto">
      ...
      <div className="mt-3 flex gap-4 text-xs text-slate-400">
        <span className="flex items-center gap-1.5">
          <span className="w-3 h-3 rounded-bs-sm bg-emerald-900/60 border border-emerald-700" />
          Homozygous dominant
        </span>
        <span className="flex items-center gap-1.5">
          <span className="w-3 h-3 rounded-bs-sm bg-indigo-900/60 border border-indigo-700" />
          Heterozygous
        </span>
        <span className="flex items-center gap-1.5">
          <span className="w-3 h-3 rounded-bs-sm bg-rose-900/60 border border-rose-700" />
